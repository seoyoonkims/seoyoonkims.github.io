...
- YOLO v5
  ...
  labelme로 landmine을 라벨링 하여 데이터를 학습시켰다. Class 당 150장 정도의 사진을 이용하였다.
  300 epochs를 학습시켰는데 12시간 정도 걸렸다.
...
![Yolo Result2](../images/results2.jpg) 

  Realsense 카메라를 켜고 roslaunch yolov5_ros yolov5.launch를 한 결과이다. 지뢰를 잘 인식하는 것을 볼 수 있다.
